...
<form method="POST" action="/admin/change-password" class="max-w-md space-y-4 bg-white rounded-xl border p-6">
    <?= Csrf::field() ?>
    <div>
    ...
    <button type="submit" class="bg-slate-800 text-white rounded-lg px-4 py-2 font-medium hover:bg-slate-900">
        Simpan Password
    </button>
</form>
