...
?>
<div>
    <h1 class="text-2xl font-bold text-gray-800 mb-2">Laporan Data Grooming</h1>
    ...
    <form method="GET" action="/admin/laporan/grooming" class="mb-6 flex flex-wrap items-end gap-3 print:hidden">
        <div>
    ...
    <div id="laporan-print" class="space-y-6 print:shadow-none">
        <div class="hidden print:block">
            <h2 class="text-xl font-bold text-gray-800">Laporan Data Grooming</h2>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-xl border p-4 print:border print:shadow-none">
                <div class="text-sm text-gray-500 mb-2">Per Jenis Grooming</div>
                    ...
                    <ul class="text-sm space-y-1">
                        <?php foreach ($metrics['breakdown_jenis'] as $item): ?>
                            <li class="flex justify-between gap-2">
                                <span><?= e($item['jenis_nama']) ?></span>
                                <span class="text-gray-600 shrink-0"><?= e((string) $item['jumlah']) ?> · Rp <?= e(number_format((float) $item['pendapatan'], 0, ',', '.')) ?></span>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                <?php endif; ?>
                        ...
                        <tbody class="divide-y">
                            <?php foreach ($rows as $row): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-2"><?= e((string) $row['jenis_nama']) ?></td>
